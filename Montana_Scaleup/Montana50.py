...
cols = [i for i in range(2, 52)]
x = genfromtxt("E:\\Work\\GANN\\Data\\mydata50.csv", delimiter=',', skip_header=1, usecols=cols)
y = genfromtxt("E:\\Work\\GANN\\Data\\mydata50.csv", delimiter=',', skip_header=1, usecols=(1,))
