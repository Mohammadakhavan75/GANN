...
cols = [i for i in range(2, 252)]
x = genfromtxt("E:\\Work\\GANN\\Data\\mydata250.csv", delimiter=',', skip_header=1, usecols=cols)
y = genfromtxt("E:\\Work\\GANN\\Data\\mydata250.csv", delimiter=',', skip_header=1, usecols=(1,))
