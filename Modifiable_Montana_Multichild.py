...
# fitness_of_generation = np.zeros((len(fit_result),generations))
...
for g in range(0, generations):
    ...
    #     fitness_of_generation[g][i] = fit_result[i]
    ...
    # children_of_generation.append(temp)

# ax = [i+1 for i in range(0, generations)]
# plt.subplots_adjust(hspace=0.2, wspace=0.2)
# plt.plot(ax,fitness_of_generation,'r.')
# plt.plot(ax,children_of_generation,'b.')
# plt.savefig('fitness_plot.png',dpi=5000)
